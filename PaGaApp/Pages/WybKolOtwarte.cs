...
{   
    public partial class WybKolOtwarte : Form
    {
        ...
        public void wyplenienie()
        {
            ...
            {
                if (Properties.Settings.Default.Col1ToDo.Count > 0)
                {
                    foreach (var item in Properties.Settings.Default.Col1ToDo)
                    {
                ...
                {
                    if (Properties.Settings.Default.Col2ToDo.Count == 0)
                    {
                ...
                if (Properties.Settings.Default.Col2ToDo.Count > 0)
                {
                    foreach (var item in Properties.Settings.Default.Col2ToDo)
                    {
        ...
        private void WybKolOtwarte_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            if (Properties.Settings.Default.Col1ToDo.Count>0)
                Properties.Settings.Default.Col1ToDo.Clear();
            if (Properties.Settings.Default.Col2ToDo.Count>0)
                Properties.Settings.Default.Col2ToDo.Clear();
            Properties.Settings.Default.Col1ToDo = col1;
            Properties.Settings.Default.Col2ToDo = col2;
